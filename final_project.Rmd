...
## Q5. Are males or females more likely to get Coccidioidomycosis? {.tabset}
...
### In California
The findings in California were consistent with Kern County. Based on a chi-squared goodness of fit test, males are more likely to get Coccidioidomycosis in California ($p<2.2*10{-16}$). A mixed model also found that sex is a good predictor of whether a person has Coccidioidomycosis ($p=0.00447$). Year was also found to be a good predictor for Coccidioidomycosis status in California from 2001-2022 ($p=0.00332$). However, population was **not** found to be a good predictor in the model ($p=0.0881$).
